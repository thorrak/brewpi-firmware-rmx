 ...
 * to PD3) for SDA and digital pin 13 (corresponding to PB5) for SCL on a
 * standard Arduino, you have to use the following definitions: 
 * #define SDA_PIN 3 
